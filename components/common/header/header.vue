		...
		<view class="left" @click="personalClick">
			<slot name='left'>
				...
				<view class="personal" :class="{'show':!show}">
					...
					<text @click="newsClick">消息提醒</text>
	...
	export default {
		...
		methods: {
			...
			scanClick() {
				...
				//       }
				//   });
				let deviceNumber ='ass1119'
					uni.request({
						// url: 'http://192.168.1.238:9900/app/office/station/info/{deviceNumber}',
						url: `http://82.157.34.130:9901/app/office/station/info/${deviceNumber}`,
						header: {
