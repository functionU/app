<template>
	<view class="tip">
		<view class="left">
			<view class="tip-item-first" >
				<image src="../../../static/app/icon-title@2X.png"
					style="width: calc(750rpx * 14/ 375);height: calc(750rpx * 14/ 375);margin-top: 1px;"></image>
				{{item.name}}
			</view>
		</view>
		...
		<view class="tip-item-second">
			<slot name="right">
				<image src="../../../static/app/cityPosition.svg"
					style="width: calc(750rpx * 11/ 375);height: calc(750rpx * 11/ 375);"></image>
...
<style>
	.tip {
		...
		padding-top: calc(100vh * 23 / 812);
	}

	.tip .tip-item-first {
		width: auto;
		margin-left: calc(750rpx * 26/ 375);
		line-height: calc(100vh * 20/812);
		font-weight: bold;
		font-size: calc(750rpx * 14/ 375);
	}

	.tip image {
		margin-right: calc(750rpx * 8/ 375);
	...
	.tip .tip-item-second {
		...
		margin-right: calc(750rpx * 28/ 375);
